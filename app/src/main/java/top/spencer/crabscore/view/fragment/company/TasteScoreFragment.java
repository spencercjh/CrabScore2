 ...
 * @author spencercjh
 */
public class TasteScoreFragment extends Fragment {
    private View view;

    public static TasteScoreFragment newInstance(String name) {
        Bundle args = new Bundle();
        args.putString("name", name);
        TasteScoreFragment fragment = new TasteScoreFragment();
