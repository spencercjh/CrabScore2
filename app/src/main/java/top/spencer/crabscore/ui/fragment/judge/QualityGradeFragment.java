...
import top.spencer.crabscore.ui.activity.judge.GradeQualityScoreListActivity;
 ...
 * @author spencercjh
 */
public class QualityGradeFragment extends BaseFragment implements GradeListView, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initGroupListAdapter() {
        ...
        groupGradeListAdapter.setOnItemClickListener(new MyOnItemClickListener() {
            ...
            public void onItemClick(View view) {
                ...
                Intent intent = new Intent(getContext(), GradeQualityScoreListActivity.class);
