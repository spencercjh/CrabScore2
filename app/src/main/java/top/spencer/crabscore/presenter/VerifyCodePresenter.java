...
public class VerifyCodePresenter extends BasePresenter<VerifyCodeView> {
     ...
     * @see top.spencer.crabscore.model.model.RegistModel
     */
     ...
     * @see top.spencer.crabscore.model.model.ForgetPasswordModel
     */
     ...
     *
     * @param mobile 手机号
     * @see top.spencer.crabscore.model.model.SendCodeModel
     */
     ...
     * @param mobile 手机号
     * @param code   验证码
     * @see top.spencer.crabscore.model.model.VerifyCodeModel
     */
